...
# *** Run ***
sleep 10
echo "Phase 1+2: Test --> run_pink2/${DIST}/pre_${RATIO}.fio\n"
$FIO_COMMAND "run_pink2/${DIST}/pre_${RATIO}.fio"

sleep 120
echo "Phase 3: Test --> run_pink2/${DIST}/${RATIO}.fio\n"
$FIO_COMMAND "run_pink2/${DIST}/${RATIO}.fio"
