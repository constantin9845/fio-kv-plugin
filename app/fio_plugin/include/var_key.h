...
static inline void reset(void){
	...
	KEY_COUNTER_READ_1 = 1;
	KEY_COUNTER_READ_2 = 1;
	KEY_COUNTER_READ_3 = 1;
	KEY_COUNTER_READ_4 = 1;
	KEY_COUNTER_READ_5 = 1;
	KEY_COUNTER_READ_6 = 1;

	KEY_COUNTER_WRITE_1 = 1;
	KEY_COUNTER_WRITE_2 = 1;
	KEY_COUNTER_WRITE_3 = 1;
	KEY_COUNTER_WRITE_4 = 1;
	KEY_COUNTER_WRITE_5 = 1;
	KEY_COUNTER_WRITE_6 = 1;

	VALUE_COUNTER_READ_1 = 1;
	VALUE_COUNTER_READ_2 = 1;
	VALUE_COUNTER_READ_3 = 1;
	VALUE_COUNTER_READ_4 = 1;
	VALUE_COUNTER_READ_5 = 1;
	VALUE_COUNTER_READ_6 = 1;

	VALUE_COUNTER_WRITE_1 = 1;
	VALUE_COUNTER_WRITE_2 = 1;
	VALUE_COUNTER_WRITE_3 = 1;
	VALUE_COUNTER_WRITE_4 = 1;
	VALUE_COUNTER_WRITE_5 = 1;
	VALUE_COUNTER_WRITE_6 = 1;
}
